...
export default function Login_menu(){
    return(
        <div className="w-screen h-screen flex items-center justify-center">
            <div className="bg-white dark:bg-black border border-white p-10 ">
                ...
                <form className="text-base md:text-2xl">
                    ...
                    <div className="flex items-center justify-between mt-5">
                        <input className="bg-white dark:bg-black p-3 border border-white w-full button" type="submit" value={'Wyślij zgłoszenie'}/>
                    </div>
                </form>
            </div>
        </div>
