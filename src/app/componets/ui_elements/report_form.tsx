            ...
            <div className="w-full h-full flex justify-center items-center">
                ...
                <div className="border border-black dark:border-white p-5">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={send}>
                        ...
                        <textarea className="border border-black dark:border-white bg-white dark:bg-black p-3 min-w-full" id="description" name="description" required rows={4} ref={field as LegacyRef<HTMLTextAreaElement>}/>
                        <Field label="Nr sali" id='room_number' type='text'/>
                        <button type='submit' className="button py-3 px-5 border cursor-pointer border-black dark:border-white">
                            Wyślij
                        </button>
                    </form>
                </div>
