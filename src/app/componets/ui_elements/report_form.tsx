        ...
        return (
            <div className="w-full h-full flex justify-center items-center">
                ...
                <div className="border border-white p-5">
                    <p className="text-sm md:text-base max-w-fit mb-1 p-2 min-w-full text-center border hidden" ref={confirm_box}></p>
                    ...
                    <form className="flex flex-col gap-4" onSubmit={send}>
                        ...
                        <textarea className="border border-white bg-black p-3 min-w-full" id="description" name="description" required rows={4} ref={field}/>
